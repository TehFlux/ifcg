...
testName = "Ray traversal #4: Model"
...
sourceName0 = 'unnamed'
targetName0 = 'unnamed_int_ext'

voxelInputFile0 = (lc.voxelizationPath  + '/' + lc.dataSetName 
    + ('/level_%02d' % voxelizeDepth) + '/' + sourceName0 + '.vgnodeh')
voxelOutputFile0 = (lc.voxelizationPath  + '/' + lc.dataSetName 
    + ('/level_%02d' % voxelizeDepth) + '/' + targetName0 + '.vgnodeh')
...
iobProc0.setKeepExistingClassification(True)
...
minWallThickness = wtProc0.getMinWallThickness()
maxWallThickness = wtProc0.getMaxWallThickness()
...
print("    Wall thickness range:       %d - %d" 
    % (minWallThickness, maxWallThickness))
