...
import CIFVG as vg
from IFVG import utils as vgu
import ifvg_local_config as lc

testName = "Voxelization #4: Mesh"
...
meshInputFile0 = lc.geoutilsDir + '/data/meshes/icosphere01.xml'
voxelOutputFile0 = 'temp/icosphere01.vgnodeh'
...
clock0 = cg.Clock()
clock0.start()
mesh0 = vgu.loadMesh(meshInputFile0)
clock0.stop()
...
s1 = s0
s2 = octreeScale * (1. - 2. * m0) / s1 * meshScale
...
clock0.start()
numVoxelsFilled = root0.voxelizeFaces(proc0, voxelizeDepth, 
