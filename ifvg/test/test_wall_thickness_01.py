...
testName = "Wall thickness #1: Icosphere (single ray)"
...
print("Interior/exterior/boundary classification...")
...
print(("  %d rays cast, %d nodes intersected in %f secs "
    + "(%f rays/sec, %f nodes/sec)") 
        % (numRays, numIntersections, t0, raysPerSec, 
            intersectionsPerSec))
