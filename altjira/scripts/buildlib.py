...
ALTJIRA_PREFIX = "/home/flux2/svn/stuff/trunk/altjira"
...
ALTJIRA_INCLUDE_PATH = IFMAPPING_PREFIX + os.path.sep + "include"
ALTJIRA_LIB_PATH = IFMAPPING_PREFIX + os.path.sep + "lib"

sourceDir = ALTJIRA_PREFIX + os.path.sep + "src"
"""Source directory."""
mapFile = (ALTJIRA_PREFIX + os.path.sep + "temp" + os.path.sep 
    + "libaltjira_src_map.py")
"""Map file."""

ALTJIRA_LIB_MODULES = None
...
def buildModule(fileRecord):
    ...
    c0 = ("g++ -fPIC -shared -g -c -o build" + os.path.sep + root + ".os " 
        ...
        + "-I" + IFOBJECT_INCLUDE_PATH + " -Ideps" + os.path.sep + "tinyxml" 
...
if ((len(newFiles) > 0)
    ...
    linkLib(allFiles, 'altjira', ALTJIRA_LIB_MODULES)
