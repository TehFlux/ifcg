...
# mail@ionflux.org
# --------------------------------------------------------------------------
# ifmappingtest04.py          Test script.
# ==========================================================================
# 
...
def createRandomPoints(generator, numPoints, style, width = 1000, 
    height = 1000, xMin = 0., xMax = 1., yMin = 0., yMax = 1., boxSize = 10.):
    ...
    for i in range(0, numPoints):
        ...
        while ((x0 > xMax) 
            ...
            x0 = generator(0.)
            y0 = generator(0.)
        xb = width * ((x0 - xMin) / (xMax - xMin) - 0.5)
        yb = height * ((y0 - yMin) / (yMax - yMin) - 0.5)
        createBox(ps0, xb, yb, boxSize)
    svg0 = ps0.getSVG(cg.getSVGPolygonStyle(style), "random", cg.AXIS_Z)
    return svg0

def testRandomGenerator(generator, numPoints, style, outFile, svg0 = "", 
    xMin = 0., xMax = 1., yMin = 0., yMax = 1., width = 1000, height = 1000):
    """Test random generator."""
    svg1 = createRandomPoints(generator, numPoints, style, width, height, 
        xMin, xMax, yMin, yMax)
...
r0 = im.Random.create()
ms0.addMapping(r0)
testRandomGenerator(r0, numPoints, redBoxStyle, 
    'temp' + os.path.sep + 'random01.svg')
print("  RandomNorm...")
r1 = im.RandomNorm.create()
ms0.addMapping(r1)
r1.setStdDev(1. / 3.)
testRandomGenerator(r1, numPoints, redBoxStyle, 
    'temp' + os.path.sep + 'random02.svg', "", 
    -1., 1., -1., 1.)
print("  RandomDensity (#1)...")
r2 = im.RandomDensity.create()
ms0.addMapping(r2)
r2.setFunc(m7)
svg0 = sampleMappings([m7], styles, width, height)
testRandomGenerator(r2, numPoints, redBoxStyle, 
    'temp' + os.path.sep + 'random03.svg', svg0)
print("  RandomDensity (#2)...")
r3 = im.RandomDensity.create()
ms0.addMapping(r3)
r3.setFunc(m8)
svg0 = sampleMappings([m8], styles, width, height)
testRandomGenerator(r3, numPoints, redBoxStyle, 
    'temp' + os.path.sep + 'random04.svg', svg0)
print("  RandomDensity (#3)...")
r4 = im.RandomDensity.create()
ms0.addMapping(r4)
r4.setFunc(m3)
svg0 = sampleMappings([m3], styles, width, height)
testRandomGenerator(r4, numPoints, redBoxStyle, 
    'temp' + os.path.sep + 'random05.svg', svg0)
