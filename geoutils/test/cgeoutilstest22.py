...
# Part 7: Write the output file.

n17 = cg.WriteSVG.create()
n17.setFileName(svgSheetFileName)
n17.setWidth(width)
n17.setHeight(height)
n17.setOriginX(int(0.5 * width))
n17.setOriginY(int(0.5 * height))
n17.setElementIDPrefix('tshape')
n17.setAxis(cg.AXIS_Z)
n17.setShapeType(cg.SHAPE_TYPE_PATH)
n17.addStyles(styles)
n17.setID('n17')

nodes5 = [ shape0, scale0, batch0, batch2, n14, n15, batch1, n16, n17 ]
