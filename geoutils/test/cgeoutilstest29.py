...
print("  Loading mesh from file '" + inFile0 + "'...")
g0 = cg.TransformableGroup()
m0 = cg.Mesh.create()
cg.getMesh(inFile0, meshID, m0)
g0.addItem(m0)
m0.scale(cg.Vector3(objectScale, objectScale, objectScale))
m0.applyTransform()
...
m0.transformVI(V, I)
m0.applyTransform()
m0.sortFaces(cg.FaceCompareAxis.create(cg.AXIS_Y))
#m0.removeBackfaces(cg.Vector3.E_Y.flip())
