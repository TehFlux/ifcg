...
void Camera::loadFromXMLFile(const std::string& fileName, const 
...
Camera::getXMLObjectFactory()
{
	static Ionflux::GeoUtils::XMLUtils::CameraXMLFactory* fac0 = 0;
    if (fac0 == 0)
    {
        fac0 = Ionflux::GeoUtils::XMLUtils::CameraXMLFactory::create();
        fac0->addRef();
